...
class _StatScreenState extends State<StatScreen>
      ...
      child: Row(
        ...
        children: [
          ...
          IconButton(
            ...
            onPressed: () {
              _selectDateRange(context); // Gọi ngay khi nhấn
            },
          ),
        ],
      ),
  ...
  Widget _buildPieChartSection(
    ...
    List<Color> colorList = [
      theme.primary.withRed(255).withGreen(150).withBlue(128),
      theme.secondary.withRed(50).withGreen(190).withBlue(50),
      theme.tertiary.withRed(255).withGreen(90).withBlue(90),
